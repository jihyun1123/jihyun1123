...
|FIND US FIND ME|2024.10 ~ 2024.12|아두이노 활용 프로젝트|프론트엔드|
|타밭슈(Tabatsu)|2024.09 ~ 2024.12|3d 프린팅 자전거 큐싱문제 해결 어플 제작|프론트엔드|
|MeowBTI|2025.02 ~ 2025.03|고양이캐릭터 + 2024년도 cat mi을 이용한 MBTI 테스트 사이트|1인 개발|

## 💎Contest
|**활동**|**기간**|**활동 내용**|**수상**|
|-----------------------------------|---------|----------------------------------|--------|
|2024 SW융합클러스터2.0 세종DX 해커톤|2024.01 ~|IT 연합 동아리 멋쟁이 사자처럼 12기 세종DX 해커톤|인재상|
|2024 멋쟁이사자처럼 12기 중앙 해커톤|2024.01 ~|IT 연합 동아리 멋쟁이 사자처럼 12기 중앙 해커톤||
|대학간 공동 알고리즘|2024.11.16|구름에서 주최하는 '대학간 공동 알고리즘'코딩 경진대회|--|

## 🪪 Certificate
|**이름**|**기간**|**비고**|
|--------|-------|---------|
|TOPCIT|2024.10.12| nnn점|
|TOEIC|2025.08| nnn점|
|컴퓨터활용능력|2025.02|2급|
|정보처리기사|2026| |
